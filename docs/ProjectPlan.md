...
- **Not done:** no frontend button to reclaim a receipt yet; the frontend release button's new two-output path was typechecked but not clicked; `test-lifecycle.ts` / `test-v1.1-*.ts` still not re-run.
